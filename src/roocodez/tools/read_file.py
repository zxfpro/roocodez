...
read_file_tool = FunctionTool.from_defaults(
    ...
    name="read_file",
    description=(
        "Reads the content of one or more files, or specific line ranges within files. "
        "Prioritize using the 'args' parameter with an XML string for flexibility. "
        "The 'args' XML should contain one or more <file> elements, each with a <path> "
        "and optional <line_range> elements (e.g., <line_range>1-10</line_range>). "
        "Multiple files and line ranges should be specified within a single 'args' XML. "
        "Example 'args': <files><file><path>src/config.py</path></file><file><path>docs/README.md</path><line_range>1-5</line_range></file></files>. "
        "The tool returns an XML string with file contents or errors."
    ),
